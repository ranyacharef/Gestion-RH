...
import java.sql.Types;
	...
	public class ReunionRecrutement extends JFrame {
	    ...
	    private String[] m={"Non diplomé", "Technicien", "Ingenieurs" };
	    
	    public ReunionRecrutement(String s) {
	        ...
	        title.setText("Une Nouvelle Réunion De Recrutement");
	        title.setBounds(480, 40, 550, 37);
	        p.add(title);

	        Nom = new JLabel();
	        Nom.setFont(new Font("Century", 2, 24));
	        Nom.setForeground(new Color(204, 204, 204));
	        Nom.setText("Nom & Prénom Candidat: ");
	        ...
	        retour.setBounds(880,680, 119,50);
	    ...
	    private void SaveMouseClicked(MouseEvent e) {     
	 	...
	 	if(teste==1) {
	    	...
	    	String rt = "INSERT INTO reunionrec (Nom_Et_Prenom_Candidat, Date, Heure_Debut, Heure_Fin, Type_Candidat) VALUES (?, ?, ?, ?, ?)";
	    	try{
	    ...
	    public static void main(String args[]) {
	    	ReunionRecrutement o = new ReunionRecrutement("Nouvelle Réunion de Recrutement");
	       o.show();
	    }
