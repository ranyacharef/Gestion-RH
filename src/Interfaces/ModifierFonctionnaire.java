...
public class ModifierFonctionnaire extends JFrame{
	...
	public ModifierFonctionnaire(String s) {
        ...
        save.addMouseListener(new MouseAdapter() {
			...
			private void save(MouseEvent evt) {
				...
				String updateFonctionnaire = "UPDATE fonctionnaire SET cin=?, Nom=? , Prenom=? , Date_Naissance=? , Lieu_Naissance=? , Sexe=? , Adresse=?, Code_Postal=?, N_tel=?, Situation_Familial=?, Diplome=?, Contrat=?, Grade=?, Adresse_mail=? ";
				try {
					PreparedStatement statement = (PreparedStatement)c.con.prepareStatement(updateFonctionnaire);
	...
	public static void main(String[] args) {
		ModifierFonctionnaire p = new ModifierFonctionnaire("Modifier un Fonctionnaire");
		p.show();
	}
}
